...
import weekop.model.VoteType;
import weekop.service.DiscoveryService;
import weekop.service.VoteService;
...
public class VoteController extends HttpServlet {
	...
	private void updateVote(long userId, long discoveryId, VoteType voteType) {
		...
		Vote existingVote = voteService.getVoteByDiscoveryId(discoveryId, userId);
